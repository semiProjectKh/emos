	...
	<div id="carousel-example-generic" class="carousel slide"
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				<img src="image/bg/1111.jpeg">
				<div class="carousel-caption"></div>
			</div>
			<div class="item">
				<img src="image/bg/2222.jpg">
				<div class="carousel-caption"></div>
			</div>
			<div class="item">
				<img src="image/bg/3333.png">
				<div class="carousel-caption"></div>
			</div>
			<div class="item">
				<img src="image/bg/4444.jpeg">
				<div class="carousel-caption"></div>
			</div>
		</div>
	</div>
				...
				<ul class="nav navbar-nav">
					<%
						if (member == null) {
							if (store == null) {
					%>
					<li><span class="glyphicon glyphicon-lock w3-center"
						aria-hidden="true"
						onclick="document.getElementById('id02').style.display='block'">
							로그인</span></li>
					<li><span class="glyphicon glyphicon-plus w3-center"
						aria-hidden="true"><a href="/emos/views/member/enroll.jsp"
							style="text-decoration: none"> 회원가입 </a></span></li>
					<%
						} else {
					%>
					<li><span class="glyphicon glyphicon-home" aria-hidden="true"
						onclick="" style="width: 150px;"><a
							href="/emos/ceoinfo?storeNum=<%=store.getStoreNum()%>"
							style="text-decoration: none"> 매장 가기</a></span></li>
					<li><span class="glyphicon glyphicon-remove-circle"
						aria-hidden="true" onclick=""><a href="/emos/elogout"
							style="text-decoration: none"> 로그아웃</a></span></li>
					<%
						}
						} else {
					%>
					<li><span class="glyphicon glyphicon-home" aria-hidden="true"
						onclick="" style="width: 150px;"><a
							href="/emos/einfo?num=1&userid=<%=member.getUserId()%>"
							style="text-decoration: none"> 마이페이지</a></span></li>
					<li><span class="glyphicon glyphicon-remove-circle"
						aria-hidden="true" onclick=""><a href="/emos/elogout"
							style="text-decoration: none"> 로그아웃</a></span></li>
					<%
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-4">
					...
					<span id="mbtn01"
						class="glyphicon glyphicon-cutlery w3-display-middle mainbtn"
						aria-hidden="true"
						onclick='location.href="/emos/slist?category=전체메뉴"'>
				...
				<div class="col-sm-4">
					...
					%>
					<span
						class="glyphicon glyphicon-blackboard w3-display-middle mainbtn"
						aria-hidden="true"
						onclick="location.href='/emos/ceoinfo?storeNum=<%=store.getStoreNum()%>'">
						<%
							} else if(member != null){
						%> 
						<span
						...
						<div id="id03" class="w3-modal">
							<div class="w3-modal-content w3-animate-opacity" style="width:400px; padding:20px;">
								<span onclick="document.getElementById('id03').style.display='none'" class="w3-button w3-display-topright" style="border-radius:5px;">&times;</span>
