...
<body>
1. 개인정보의 수집 및 이용목적
회원의 주문과 결재를 도와주는 EMOS(이하 "사이트")은 효과적인 결재와 정보제공에 적합한 서비스를  위하여 개인정보를 수집하고 있으며 수집된 정보를 아래와 같이 이용하고 있습니다. 이용자가 제공한 모든 정보는 하기 목적에 필요한 용도 이외로는 사용되지 않으며 이용 목적이 변경될 시에는 사전 동의를 구할 것입니다.
1) 회원관리
...
2) 이력서 등록 시 수집하는 항목
필수 항목: 이름, 연락처(전화번호/휴대폰/e-메일), 우편번호(알바몬), 주소(알바몬), 학력사항, 근무형태(알바몬), 희망근무지(알바몬), 희망근무일시(알바몬), 자기소개서(알바몬), 생년월일, 성별
